...
<html>
    ...
    <body>
    <div class="tab-huako"><div class="huako">NATURE TABLE</div></div>
   <div class="container">
   ...
   <center> 
        ...
        <table border = "1" class="table table-dark table-striped">
         <thead class="table-dark">
            ...
            ?>
            <tr>
                <td><?php echo $row_select['product_nature_id'];  ?></td>
                ...
                <td><a href="product_delete.php?delete_id=<?php echo $row_select['product_nature_id']; ?>&gettablename=product_nature_tb&column=product_nature_id"
                onclick="return confirm('คุณเเน่ใจที่จะลบข้อมูลใช่หรือไม่ ?');">ลบ </a></td>  
                
                <?php 
                $columns = "product_nature_id";
                $get_table_name = "product_nature_tb";
                ?>
 
                
                <form action="multipledelete.php?gettablename=<?php echo $get_table_name; ?>&column=<?php echo $columns;?>" method = "post">
                <td>
                    <input type="checkbox"  name = "idcheckbox[]" value = "<?php echo $row_select['product_nature_id'];  ?>">
                </td>
           ...
           <td>
                ...
                <td>
                <a href="product_nature_form_insert.php" class ="btn btn-success" id ="btn-success"> -เพิ่มข้อมูลสินค้า </a>
                </td>
                <td>
