...
<html>
    ...
    <body>
    <div class="tab-huako"><div class="huako">TYPE TABLE</div></div>
        ...
        <table border = "1" class="table table-dark table-striped">
         <thead class="table-dark">
            ...
            <tr>
                ...
                <td><a href="product_type_form_update.php?update_id=<?php echo $row_select['product_type_id'];  ?>"  
                onclick="return confirm('คุณเเน่ใจที่จะเเก้ไขข้อมูลใช่หรือไม่ ?');" > เเก้ไข </a></td> 
 
                <td><a href="product_delete.php?delete_id=<?php echo $row_select['product_type_id']; ?>&gettablename=product_type_tb&column=product_type_id"
                onclick="return confirm('คุณเเน่ใจที่จะลบข้อมูลใช่หรือไม่ ?');">ลบ </a></td>  
                
                <?php 
                $columns = "product_type_id";
                $get_table_name = "product_type_tb";
                ?>
 
                
                <form action="multipledelete.php?gettablename=<?php echo $get_table_name; ?>&column=<?php echo $columns;?>" method = "post">
                <td>
                    <input type="checkbox"  name = "idcheckbox[]" value = "<?php echo $row_select['product_type_id'];  ?>">
                </td>
